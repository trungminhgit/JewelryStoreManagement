            ...
            <section className="md:mx-auto w-full md:p-0 md:w-[80%]">
                ...
                <div className="flex flex-col md:flex-row gap-0 lg:gap-16">
                    <div className="flex flex-col w-full lg:w-2/3 p-4">
                        {products&&products.map((item,index)=><CartItem key={index} name={item.item.productName} type={item.item.categoryName} price={item.item.price} quantity={item.quantity} id={item.item.productID}/>)}
                    ...
                    <div className="bg-black text-white w-full md:w-1/3">
                        ...
                        <div className="flex justify-between items-center p-3 rounded-md bg-black">
                            ...
                            <button className="bg-yellow-100 text-xl text-black px-4 py-1 rounded-md">Thanh toán</button>
                        </div>
                    </div>
                </div>
            </section>
