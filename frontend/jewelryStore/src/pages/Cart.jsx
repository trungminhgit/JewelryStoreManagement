    ...
    return (
        <>
            ...
            <section className="md:mx-auto w-full md:p-0 md:w-[80%]">
                    ...
                    <>
                        ...
                        <div className="flex flex-col md:flex-row gap-0 lg:gap-16">
                            <div className="flex flex-col w-full lg:w-2/3 p-4">
                                {products && products.map((item, index) => <CartItem key={index}
                                                                                     imageUrl={item.item.productImage}
                                                                                     name={item.item.productName}
                                                                                     type={item.item.categoryName}
                                        ...
                                        {products.map(((item, index) => {
                                            return (
                                                <div className="text-black mb-3">
                                                    ...
                                                    <p className="font-light">Quantity:&nbsp;
                                                        <span>{cart.cart[index]?.quantity}</span></p>
                                                    <p className="font-light">Total:&nbsp;
                                                        <span>{(cart.cart[index]?.quantity) * (item.item.price)}</span>
                                                    </p>
                                                </div>
                                            )
                                        }))}
                ...
                {cart.cart.length<=0&&(
                    <>
                        <h3 className="mb-12 mt-7 text-4xl ml-4 lg:ml-0 text-center">Cart empty</h3>
                    </>
                )}
            </section>
        </>
